...
public abstract class Fotografia extends piezas{
	public Fotografia(String titulo, int anio, String[] autores, String lugarCreacion, boolean disponibilidadVenta,
